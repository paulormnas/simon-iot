...
class TestSign(TestCase):
    ...
    def test_verifica_assinatura_valida(self):
        ...
        self.assertTrue(self.signature.verify_signature(self.dados_de_teste, assinatura))

    def test_verifica_assinatura_invalida(self):
        with open('assinatura_invalida.txt', 'rb') as f:
            assinatura = f.read()
            self.assertFalse(self.signature.verify_signature(self.dados_de_teste, assinatura))