...
u_curve_fit_temp = measurement.curve_fit(
    incert["standard_components"]["st_error_estimate_temp"]
)
U_st_temp = measurement.standard_uncertainty(
    incert["standard_components"]["st_temp_expanded_uncertainty"],
    incert["standard_components"]["k"],
)
...
u_stability_temp = measurement.device_stability(
    incert["temp_components"]["device_stability"]
)
u_uniformity_temp = measurement.device_uniformity(
    incert["temp_components"]["device_uniformity"]
)
...
u_curve_fit_hum = measurement.curve_fit(
    incert["standard_components"]["st_error_estimate_hum"]
)
U_st_hum = measurement.standard_uncertainty(
    incert["standard_components"]["st_hum_expanded_uncertainty"],
    incert["standard_components"]["k"],
)
...
u_stability_hum = measurement.device_stability(
    incert["hum_components"]["device_stability"]
)
u_uniformity_hum = measurement.device_uniformity(
    incert["hum_components"]["device_uniformity"]
)
u_item_hum = measurement.item_stability(incert["hum_components"]["itemstability"])


uncertainties_list_temp = [
    u_standard_temp,
    u_meter_temp,
    u_curve_fit_temp,
    U_st_temp,
...
### Temperature ###
u_comb_temp = measurement.combined_uncertainty(
    uncertainties_list_temp, incert["standard_components"]["sensitivity_coefficient"]
)
u_comb_hum = measurement.combined_uncertainty(
    uncertainties_list_hum, incert["standard_components"]["sensitivity_coefficient"]
)

### Calculation of expanded uncertainty ###
U_temp = measurement.expanded_uncertainty(
    u_comb_temp, incert["standard_components"]["k"]
)
U_hum = measurement.expanded_uncertainty(u_comb_hum, incert["standard_components"]["k"])

### Results printing  ###
print(
    "The standard deviation of the average temperature of standard device: ",
    u_standard_temp,
    "°C",
)
print(
    "The standard deviation of the average humidity of standard device: ",
    u_standard_hum,
    "%ur",
)
print(
    "The standard deviation of the average temperature of meter device: ",
    u_meter_temp,
    "°C",
)
print(
    "The standard deviation of the average humidity of meter device: ",
    u_meter_hum,
    "%ur",
)
...
print(
    "The uncertainty of the standard device from the calibration certificate temperature:",
    U_st_temp,
    "°C",
)
print(
    "The uncertainty of the standard device from the calibration certificate humidity:",
    U_st_hum,
    "°C",
)
...
print(
    "The uncertainty due to the camara stability temperature:", u_stability_temp, "°C"
)
print(
    "The uncertainty due to the camara uniformity temperature:", u_uniformity_temp, "°C"
)
